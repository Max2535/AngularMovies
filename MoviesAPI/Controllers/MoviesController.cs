...
namespace MoviesAPI.Controllers
{
    ...
    public class MoviesController:ControllerBase
    {
        ...
        public async Task<ActionResult<HomeDTO>> Get()
        {
            ...
            .Where(x=>Convert.ToBoolean(x.InTheaters))
            .OrderBy(x=>x.ReleaseDate)
            .Take(top)
            .ToListAsync();
        ...
        public async Task<ActionResult<List<MovieDTO>>> Filter([FromQuery] FilterMoviesDTO filterMoviesDTO){
            ...
            if(filterMoviesDTO.InTheaters){
                movieQueryable = movieQueryable.Where(x=>Convert.ToBoolean(x.InTheaters));
            }
            ...
            await HttpContext.InsertParametersPaginationInHeader(movieQueryable);
            var movies = await movieQueryable.OrderBy(x=>x.Title).Paginage(filterMoviesDTO.PaginationDTO)
            .ToListAsync();
